...
- **Added awesome-claude-code-hooks to Complementary Resources** (`README.md`): added a row for [loqimean/awesome-claude-code-hooks](https://github.com/loqimean/awesome-claude-code-hooks), a curated list of Claude Code hooks, to the resource discovery table.
