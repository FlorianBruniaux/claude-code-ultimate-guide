...
| [ops/api-gateway.md](./ops/api-gateway.md) | **API Gateway**: centralize cost control, budget enforcement, model allowlists, and usage tracking with LiteLLM Gateway, OrcaRouter, or Portkey | 15 min |
