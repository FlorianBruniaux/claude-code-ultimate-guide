...
This section is rendered from `machine-readable/mcp-product.json` for package 1.3.0 and guide 3.43.0.
...
```bash
npx -y @modelcontextprotocol/inspector npx -y claude-code-ultimate-guide-mcp@1.3.0
```
