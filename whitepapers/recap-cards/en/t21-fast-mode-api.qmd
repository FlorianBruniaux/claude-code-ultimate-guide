...
Fast Mode produces responses **2.5x faster** in exchange for a 2x higher cost (verified for Opus 4.8). The underlying model stays Opus 4.8, not a different one. Fast Mode prioritizes resource allocation, without simplifying reasoning.
