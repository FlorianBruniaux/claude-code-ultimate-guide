...
| **Statuts** | pending / in_progress / completed | pending / in_progress / completed |
...
```bash
# Activer les outils de tâches sur les modèles récents
...
La Tasks API est devenue le système par défaut dans v2.1.142. Depuis v2.1.233, les modèles récents désactivent les deux systèmes sauf si `CLAUDE_CODE_ENABLE_TODO_TOOLS=1` est défini. Après activation, `CLAUDE_CODE_ENABLE_TASKS=0` sélectionne l’ancien TodoWrite.
