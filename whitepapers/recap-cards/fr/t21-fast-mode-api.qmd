...
Fast Mode produit des réponses **2.5x plus rapides** en échange d'un coût 2x supérieur (vérifiée pour Opus 4.8). Le modèle sous-jacent reste Opus 4.8, et non un modèle différent. Fast Mode priorise l'allocation de ressources, sans simplifier le raisonnement.
