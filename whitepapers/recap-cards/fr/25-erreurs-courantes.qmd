...
Répéter les conventions du projet à chaque session. Centraliser dans `CLAUDE.md` tout ce qui doit être constant.

**Ignorer les avertissements de contexte**
Utiliser `/context` pour inspecter capacité et pertinence. Compacter ou préparer une passation si nécessaire ; aucun pourcentage ne garantit une qualité de réponse donnée.
