...
Glob retourne une liste de chemins sans lire leur contenu. Utiliser cet outil pour réduire l’ensemble de fichiers avant d’en lire le contenu.
...
Grep utilise ripgrep, adapté aux recherches de texte exact. Il extrait les lignes correspondantes sans charger tout le contenu.
...
Utiliser Grep pour les recherches de texte exact. Ne pas déléguer à Agent ou Bash si le motif est connu.
...
Read("auth.service.ts", offset=50, limit=71)
```
