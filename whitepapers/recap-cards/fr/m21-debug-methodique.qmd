...
Un sous-agent retourne un résumé plus court, mais ses erreurs peuvent influencer l’agent principal. Vérifier les constats qui ont des conséquences.
...
Un contexte long ou non pertinent peut rendre les contraintes importantes plus difficiles à appliquer ; aucun nombre fixe de tours ne le prédit. Si le débogage s’éternise, `/compact` résume l’historique et `/clear` repart avec les seuls éléments essentiels.
