...
cat rapport.txt | claude -p "Résume" --output-format stream-json --verbose
```
...
| Permissions | Demandes ou règles enregistrées | Règles d’autorisation ou mode borné à configurer |
| Usage | Développement | CI, scripts, pipes |
| Session | Persistante | Enregistrée par défaut ; continuation ou reprise possible |
