...
**Limite de concurrence** : fixer un plafond selon les ressources mesurées, les limites de débit et le budget. L’augmenter seulement si les tâches terminées indépendamment justifient cette coordination.
